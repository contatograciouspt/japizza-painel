  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {/* {mode === "dark" ? (
          <img src={logoLight} alt="jáPizza" width="135" className="pl-6" />
        ) : (
          <img src={logoDark} alt="jáPizza" width="135" className="pl-6" />
        )} */}
        <img src="/logo_japizza.png" alt="logo_japizza" width="135" className="pl-6" />
      </a>
      <ul className="mt-8">
        {sidebar.map((route) =>
          route.routes ? (
